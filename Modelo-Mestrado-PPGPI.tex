...
\titulo{Modelo Conceitual para Transferência de Tecnologia agrícola das IES e Centros de Pesquisa para o Campo}
%\orientador{Prof. Dr. }
\author{Luiz Diego Vidal Santos}


\curso{Desenvolvimento e Meio Ambiente}
